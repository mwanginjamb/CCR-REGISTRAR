    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row gap-6 md:gap-8">
            ...
            <div class="w-full lg:w-1/4">
                ...
                <div id="form-stepper"
                    class="sticky lg:top-24 flex flex-row lg:flex-col gap-3 md:gap-4 overflow-x-auto lg:overflow-x-visible lg:overflow-y-visible no-scrollbar pb-2 lg:pb-0 snap-x snap-mandatory lg:snap-none">

                    <!-- STEP 1 -->
                    <button type="button" data-target="patient-information"
                        class="form-step active-step flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-xl min-w-[220px] lg:min-w-0 lg:w-full flex-shrink-0 text-left transition-all hover:-translate-y-0.5 snap-start">

                        <div
                            class="step-number w-7 h-7 md:w-8 md:h-8 rounded-lg flex items-center justify-center text-sm font-bold shrink-0">
                            1
                        </div>
                        ...
                        <div class="min-w-0">
                            ...
                            <p
                                class="text-[9px] md:text-[10px] text-on-surface-variant uppercase tracking-wider font-semibold mt-0.5">
                                Step 1 of 3
                            </p>
                    ...
                    <!-- STEP 2 -->
                    <button type="button" data-target="tumour-details"
                        class="form-step inactive-step flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-xl min-w-[220px] lg:min-w-0 lg:w-full flex-shrink-0 text-left transition-all hover:-translate-y-0.5 snap-start">
                        ...
                        <div class="min-w-0">
                            ...
                            <p
                                class="text-[9px] md:text-[10px] text-outline uppercase tracking-wider font-semibold mt-0.5">
                                Step 2 of 3
                            </p>
                    ...
                    <!-- STEP 3 -->
                    <button type="button" data-target="treatment-followup"
                        class="form-step inactive-step flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-xl min-w-[220px] lg:min-w-0 lg:w-full flex-shrink-0 text-left transition-all hover:-translate-y-0.5 snap-start">
